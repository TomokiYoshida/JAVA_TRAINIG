...
public class Test {
	...
	private final String privateFinalField = "private final field";
	private final static String privateFinalStaticField = "private static final field";

	public Test(){
		System.out.println("生成");
	}
	public Test(String test){
		System.out.println("生成"+ test);
	}
	public Test(String test, String test2){
		System.out.println("生成"+ test + test2);
	}
	public Test(int test){
		System.out.println("生成int"+ test);
	}
